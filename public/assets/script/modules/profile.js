...
let response = await fetch('/my_code/php/news-project-remastered/handlers/profile/fetch-profile.php');
...
export async function updateRole() {
    ...
    let response = await fetch('/my_code/php/news-project-remastered/handlers/code/fetch-codes.php');
    ...
    roleUpdateForm.addEventListener('submit', async function (e) {
        ...
        if (!isSameRole) {
            ...
            if (!match) errors.code = `Incorrect ${selectedRole} code`;
